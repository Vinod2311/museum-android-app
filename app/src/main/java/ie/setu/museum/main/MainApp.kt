...
class MainApp : Application() {
    ...
    private fun fillJSONStore(){
        ...
        var museum1 = MuseumModel("National Museum of Ireland - Natural History","Natural History",
            ...
            lat =  53.34066, lng= -6.25301, zoom = 15f, image = Uri.parse("content://com.android.providers.media.documents/document/image%3A1000040369"))
        var museum2 = MuseumModel("National Museum of Ireland - Archaeology","History",
            ...
            lat = 53.34181, lng = -6.25464, zoom = 15f, image = Uri.parse("content://com.android.providers.media.documents/document/image%3A1000040371"))
        var museum3 = MuseumModel("Irish Museum of Modern Art","Art",
            ...
            lat = 53.34434, lng = -6.29982, zoom = 15f, image = Uri.parse("content://com.android.providers.media.documents/document/image%3A1000040373"))
        var museum4 = MuseumModel("National Maritime Museum of Ireland","History",
            ...
            lat = 53.29720, lng = -6.13263, zoom = 15f, image = Uri.parse("content://com.android.providers.media.documents/document/image%3A1000040376"))
        var museum5 = MuseumModel("The National 1798 Rebellion Centre","History",
            ...
            lat = 52.55506, lng = -6.56233, zoom = 15f, image = Uri.parse("content://com.android.providers.media.documents/document/image%3A1000040377"))
